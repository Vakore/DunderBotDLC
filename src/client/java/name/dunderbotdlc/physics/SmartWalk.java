...
public class SmartWalk {
    ...
    public static boolean[] moveInDir(SimInstance myState) {
        int toValid = 1;
        ...
        playerControlList[0] = ( myState.controlsneak);
        playerControlList[1] = (myState.controljump);
        playerControlList[2] = (myState.controlsprint);
        playerControlList[3] = (myState.controlforward);
        playerControlList[4] = (myState.controlback);
        playerControlList[5] = (myState.controlleft);
        playerControlList[6] = (myState.controlright);
